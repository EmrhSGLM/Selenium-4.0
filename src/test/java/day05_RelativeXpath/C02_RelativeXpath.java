...
public class C02_RelativeXpath {
    ...
    public static void main(String[] args) {
        ...
        WebElement byAria = driver.findElement(By.id("pid8_thumb"));
        WebElement nyCity = driver.findElement(By.id("pid3_thumb"));

        //2 ) Berlin’i  3 farkli relative locator ile locate edin
        WebElement berlin1=driver.findElement(RelativeLocator.with(By.tagName("img")).above(sailor).toLeftOf(byAria));
        WebElement berlin2=driver.findElement(RelativeLocator.with(By.tagName("img")).toRightOf(boston).toLeftOf(byAria));
        WebElement berlin3=driver.findElement(RelativeLocator.with(By.tagName("img")).below(nyCity).above(sailor));
